...
class AppConstants {
  static const String appName = 'StackFood Restaurant'; //Download from Scriptzhub.com
  static const double appVersion = 7.2;

  static const String baseUrl = 'https://stackfood-admin.6amtech.com'; //Download from Scriptzhub.com
